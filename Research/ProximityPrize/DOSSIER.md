# Delta Star research dossier

This is the canonical dossier for `SlopDotCash/proximityprize`. The complete dated v3
research record and v4 standalone update are consolidated below; their snapshots are
historical evidence, not live issue status or a new proof claim.

## Current coordination — 2026-09-06

[Issue #164](https://github.com/SlopDotCash/proximityprize/issues/164) is the consolidated
research and independent production-completion tracker. Former trackers #1 and #4 were
closed administratively. **The production theorem remains unproved.** The completion
contract requires both the BGK and incidence inputs, resolution of the attained-maximum
versus supremum translation, matching threshold bounds, and independent exact-commit
validation. The dated snapshots below do not supersede that contract.

[Issue #2](https://github.com/SlopDotCash/proximityprize/issues/2) tracks the remaining
cleanup and library/research separation. Pushes and PRs must target
`SlopDotCash/proximityprize`; never submit to `Verified-zkEVM/ArkLib`.
The [disproof log](DISPROOF_LOG.md) preserves the detailed anti-repeat record.
...
[`deltastar-DOSSIER-v3-2026-07-01.md`](DOSSIER.md#campaign-dossier-through-2026-07-11); v3 remains the full
...
in [`Research/ProximityPrize/DISPROOF_LOG.md`](DISPROOF_LOG.md), the frontier module docstrings, and the exact probes
...
[`docs/wiki/residual-census.md`](../../docs/wiki/residual-census.md); only the 2026-08-16 figures are the
current totals.
...
<!-- END retained v4 dossier -->

## Campaign dossier through 2026-07-11

<!-- BEGIN retained v3 dossier -->
...
> workspace is [`Research/ProximityPrize/LegacyWorkbench.lean`](LegacyWorkbench.lean).
