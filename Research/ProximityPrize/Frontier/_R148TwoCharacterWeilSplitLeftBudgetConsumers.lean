...
/-- Max-budget hzero-free Jacobi/Weil start at `r = 2`, followed by monotone left-budget
propagation. -/
theorem iterConvEnergyWick_from_two_of_twoCharacterWeilInput_maxBudget_left_budget_le_const
    (hχ : IsMulCharC χ) (hχ1 : χ 1 = 1)
    (hfam : SubgroupDualFamily G m lam) (hgrp : DualFamilyGroupLaw m lam)
...
/-- Max-budget hzero-free Jacobi/Weil start at `r = 3`, followed by monotone left-budget
propagation. -/
theorem iterConvEnergyWick_from_three_of_twoCharacterWeilInput_maxBudget_left_budget_le_const
    (hχ : IsMulCharC χ) (hχ1 : χ 1 = 1)
    (hfam : SubgroupDualFamily G m lam) (hgrp : DualFamilyGroupLaw m lam)
...
/-- Max-budget hzero-free Jacobi/Weil start at `r = 2`, propagated and consumed by the public
pointwise pure-face bound using the monotone left-budget interface. -/
theorem sup_pureFace_from_two_of_twoCharacterWeilInput_maxBudget_left_budget_le_const
    (hχ : IsMulCharC χ) (hχ1 : χ 1 = 1)
    (hfam : SubgroupDualFamily G m lam) (hgrp : DualFamilyGroupLaw m lam)
    (k : ℕ) {Cweil B Ctwo C C' : ℝ} (hB0 : 0 ≤ B)
    (hJ : ∀ c : ZMod m, ‖jacobiCoeff χ lam c‖ ≤ B)
...
/-- Max-budget hzero-free Jacobi/Weil start at `r = 3`, propagated and consumed by the public
pointwise pure-face bound using the monotone left-budget interface. -/
theorem sup_pureFace_from_three_of_twoCharacterWeilInput_maxBudget_left_budget_le_const
    (hχ : IsMulCharC χ) (hχ1 : χ 1 = 1)
    (hfam : SubgroupDualFamily G m lam) (hgrp : DualFamilyGroupLaw m lam)
    (k : ℕ) {Cweil B Ctriple C C' : ℝ} (hB0 : 0 ≤ B)
    (hJ : ∀ c : ZMod m, ‖jacobiCoeff χ lam c‖ ≤ B)
...
#print axioms iterConvEnergyWick_from_two_of_twoCharacterWeilInput_maxBudget_left_budget_le_const
#print axioms iterConvEnergyWick_from_three_of_twoCharacterWeilInput_maxBudget_left_budget_le_const
#print axioms sup_pureFace_from_two_of_twoCharacterWeilInput_maxBudget_left_budget_le_const
#print axioms sup_pureFace_from_three_of_twoCharacterWeilInput_maxBudget_left_budget_le_const
