...
scanners split failed production into either the combined arithmetic failure or a concrete
appearing codeword whose singleton-witness scalar fiber exceeds the proposed cap.
