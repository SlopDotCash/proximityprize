...
Combined validation with PR #196 at local commit `52f316e38dbb8fdd764bb231e19ac10fe000d331` passed all 37 Python tests. That combined run precedes the additional exhaustive-census test above, which passed separately. This evidence does not establish a full Lean build.
