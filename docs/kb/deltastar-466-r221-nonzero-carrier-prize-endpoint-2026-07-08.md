...
- `Research/ProximityPrize/Frontier/_R221NonzeroCarrierPrizeEndpoint.lean`
...
```bash
./scripts/pg-iterate.sh Research/ProximityPrize/Frontier/_R221NonzeroCarrierPrizeEndpoint.lean
```
