...
theorem prime_423237889 : Nat.Prime 423237889 := by decide

/-- The witness prime carries a primitive 128-th root: `128 ∣ p - 1`. -/
theorem dvd_128_pred : (128 : ℕ) ∣ 423237889 - 1 := by decide

/-- The witness prime exceeds `128 ^ 4`. -/
theorem gt_n4 : (128 : ℕ) ^ 4 < 423237889 := by decide

/-- `ζ = 90645509` is a 128-th root of unity in `ZMod 423237889`. -/
theorem zeta_pow128 : ((90645509 : ZMod 423237889)) ^ 128 = 1 := by decide

/-- `ζ` has order exactly `128`: it is not a 64-th root, so (as `128 = 2 ^ 7`) its
order is `128`. -/
theorem zeta_pow64_ne : ((90645509 : ZMod 423237889)) ^ 64 ≠ 1 := by decide
