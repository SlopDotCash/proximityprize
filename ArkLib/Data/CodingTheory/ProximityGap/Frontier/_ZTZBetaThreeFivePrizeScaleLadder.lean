...
theorem tzPrimeSupply_two_pow_30_three : TZPrimeSupply 1073741824 (3 : ℝ) 12 := by
  ...
  have hsub : ({
      ...
      2347733941691609857279393793, 2364054440256407351137927169} : Finset ℕ) ⊆ tzWindow 1073741824 (3 : ℝ) := by
    intro p hp
  ...
  calc (12 : ℕ)
      ...
      2050338190066411080301674497, 2164581680019993537311408129,
      2195409288420166581266415617, 2237117229196871287793778689,
      2347733941691609857279393793, 2364054440256407351137927169} : Finset ℕ).card := by decide
...
theorem tzPrimeSupply_two_pow_30_five : TZPrimeSupply 1073741824 (5 : ℝ) 12 := by
  ...
  have hsub : ({
      ...
      2626261196270707915902417322202354697977724929} : Finset ℕ) ⊆ tzWindow 1073741824 (5 : ℝ) := by
    intro p hp
    fin_cases hp <;> assumption
  calc (12 : ℕ)
      = ({
      ...
      2434962616364562414266431238894792971934236673,
      2576084519574014013833961956088895884589268993,
      2626261196270707915902417322202354697977724929} : Finset ℕ).card := by decide
