...
theorem tzPrimeSupply_512_four : TZPrimeSupply 512 (4 : ℝ) 12 := by
  ...
  have hsub : ({
      ...
      110595407873, 122675003393, 126298882049, 127104188417, 128312147969, 130728067073} : Finset ℕ) ⊆ tzWindow 512 (4 : ℝ) := by
    intro p hp
    fin_cases hp <;> assumption
  calc (12 : ℕ)
      = ({
      69323456513, 76369887233, 78383153153, 80396419073, 88852135937, 96502546433,
      110595407873, 122675003393, 126298882049, 127104188417, 128312147969, 130728067073} : Finset ℕ).card := by decide
