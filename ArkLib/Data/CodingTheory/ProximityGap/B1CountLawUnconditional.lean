...
in a field `F`, with `2 ≤ n` and `1 ≤ k+1 ≤ n-1`, the `(k+1)`-subset products of `nthRootsFinset n
  1`
...
distinct B1 top-direction divided-difference readouts over `(k+1)`-subsets of `μ_n = nthRootsFinset
  n 1`
