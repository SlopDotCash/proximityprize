...
theorem βHensel_weight_bound_unlocked_of_normalized_divWeight_cases_of_fullVanishes
    ...
    weight_Λ_over_𝒪 hH (βHensel H x₀ R hHyp t) D
      ≤ WithBot.some ((2 * t + 1) * Bivariate.natDegreeY R * D) :=
  AlphaWeight.βHensel_weight_bound_of_alphaWeight_succLift'
    H x₀ R hHyp hH hDH hDRx0 hdR2 hdHR hW
    (fun t => (P2_closed_of_fullVanishes H x₀ R hHyp hvan).2 (t + 1))
    (alphaWeight_of_normalized_divWeight_cases_of_fullVanishes
      H x₀ R hHyp hH D hvan h0 hsucc)
...
/-- Restricted P2 matching routes normalized divisibility base/successor targets directly to the
P1 `βHensel` weight-bound endpoint. -/
theorem βHensel_weight_bound_unlocked_of_normalized_divWeight_cases_of_restrictedMatch
    (x₀ : F) (R : F[X][X][Y]) (hHyp : ClaimA2.Hypotheses x₀ R H)
    (hH : 0 < H.natDegree) {D : ℕ}
    (hDH : Bivariate.totalDegree H ≤ D)
    (hDRx0 : D ≥ Bivariate.totalDegree (Bivariate.evalX (Polynomial.C x₀) R))
...
/-- All-prefix P1 weight bounds from full P2 vanishing and normalized divisibility cases. -/
theorem βHensel_weight_bound_all_unlocked_of_normalized_divWeight_cases_of_fullVanishes
    (x₀ : F) (R : F[X][X][Y]) (hHyp : ClaimA2.Hypotheses x₀ R H)
    (hH : 0 < H.natDegree) {D : ℕ}
    (hDH : Bivariate.totalDegree H ≤ D)
    (hDRx0 : D ≥ Bivariate.totalDegree (Bivariate.evalX (Polynomial.C x₀) R))
    ...
    ∀ t, weight_Λ_over_𝒪 hH (βHensel H x₀ R hHyp t) D
      ≤ WithBot.some ((2 * t + 1) * Bivariate.natDegreeY R * D) :=
  fun t =>
    βHensel_weight_bound_unlocked_of_normalized_divWeight_cases_of_fullVanishes
      H x₀ R hHyp hH hDH hDRx0 hdR2 hdHR hW hvan h0 hsucc t

/-- All-prefix P1 weight bounds from restricted P2 matching and normalized divisibility cases. -/
theorem βHensel_weight_bound_all_unlocked_of_normalized_divWeight_cases_of_restrictedMatch
    (x₀ : F) (R : F[X][X][Y]) (hHyp : ClaimA2.Hypotheses x₀ R H)
    (hH : 0 < H.natDegree) {D : ℕ}
    (hDH : Bivariate.totalDegree H ≤ D)
    (hDRx0 : D ≥ Bivariate.totalDegree (Bivariate.evalX (Polynomial.C x₀) R))
  ...
  fun t =>
    βHensel_weight_bound_unlocked_of_normalized_divWeight_cases_of_restrictedMatch
      H x₀ R hHyp hH hDH hDRx0 hdR2 hdHR hW hmatch h0 hsucc t
...
#print axioms
  BCIKS20.HenselNumerator.βHenselStructuredWeightInvariant_unlocked_of_divWeight_clearedBaseCases
open BCIKS20.HenselNumerator
#print axioms
  βHenselStructuredWeightInvariant_unlocked_of_alphaWeight_clearedBaseCases_succLift
#print axioms
  BCIKS20.HenselNumerator.βHenselStructuredWeightInvariant_unlocked_of_fullVanishes_clearedBaseCases
open BCIKS20.HenselNumerator
#print axioms
  βHenselStructuredWeightInvariant_unlocked_of_restrictedMatch_clearedBaseCases
#print axioms BCIKS20.HenselNumerator.βHensel_weight_bound_unlocked_of_divWeight_clearedBaseCases
#print axioms
  BCIKS20.HenselNumerator.βHensel_weight_bound_unlocked_of_alphaWeight_clearedBaseCases_succLift
#print axioms BCIKS20.HenselNumerator.βHensel_weight_bound_unlocked_of_fullVanishes_clearedBaseCases
#print axioms
  BCIKS20.HenselNumerator.βHensel_weight_bound_unlocked_of_restrictedMatch_clearedBaseCases
open BCIKS20.HenselNumerator
#print axioms
...
#print axioms
  BCIKS20.HenselNumerator.βHensel_weight_bound_all_unlocked_of_divWeight_clearedBaseCases
#print axioms
  BCIKS20.HenselNumerator.βHensel_weight_bound_all_unlocked_of_alphaWeight_clearedBaseCases_succLift
#print axioms
  BCIKS20.HenselNumerator.βHensel_weight_bound_all_unlocked_of_fullVanishes_clearedBaseCases
#print axioms
  BCIKS20.HenselNumerator.βHensel_weight_bound_all_unlocked_of_restrictedMatch_clearedBaseCases
#print axioms
  BCIKS20.HenselNumerator.alphaWeight_successors_iff_divWeight_successors_of_fullVanishes
#print axioms
  BCIKS20.HenselNumerator.alphaWeight_successors_iff_divWeight_successors_of_restrictedMatch
...
open BCIKS20.HenselNumerator
#print axioms
  βHensel_weight_bound_all_unlocked_of_normalized_divWeight_cases_of_fullVanishes
open BCIKS20.HenselNumerator
#print axioms
  βHensel_weight_bound_all_unlocked_of_normalized_divWeight_cases_of_restrictedMatch
open BCIKS20.HenselNumerator
#print axioms
  alphaWeight_clearedBaseCases_iff_divWeight_successors_of_fullVanishes_fixed
open BCIKS20.HenselNumerator
#print axioms
  divWeight_clearedBaseCases_iff_alphaWeight_successors_of_fullVanishes_fixed
open BCIKS20.HenselNumerator
#print axioms
...
#print axioms
  BCIKS20.HenselNumerator.βHensel_weight_bound_unlocked_of_alphaWeight_successors_fixed_succLift
#print axioms BCIKS20.HenselNumerator.βHensel_weight_bound_unlocked_of_fullVanishes_successors_fixed
#print axioms
  BCIKS20.HenselNumerator.βHensel_weight_bound_unlocked_of_restrictedMatch_successors_fixed
#print axioms
  BCIKS20.HenselNumerator.βHensel_weight_bound_all_unlocked_of_divWeight_successors_fixed
#print axioms
  BCIKS20.HenselNumerator.βHensel_weight_bound_all_unlocked_of_alphaWeight_successors_fixed_succLift
#print axioms
  BCIKS20.HenselNumerator.βHensel_weight_bound_all_unlocked_of_fullVanishes_successors_fixed
#print axioms
  BCIKS20.HenselNumerator.βHensel_weight_bound_all_unlocked_of_restrictedMatch_successors_fixed
